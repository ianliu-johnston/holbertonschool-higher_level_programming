...
print("////////////////\\\\\\\\\\\\\\\\\\//////////////\\\\\\\\")
print("Creating a new square, from rectangle class")
too_square_for_party = Rectangle.square(5)
print("Area: {}".format(too_square_for_party.area()))
print("Perimeter: {}".format(too_square_for_party.perimeter()))
print(str(too_square_for_party))
